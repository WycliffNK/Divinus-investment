    ...
    <>
      ...
      <section style={{ padding: "100px 0 80px", background: "linear-gradient(180deg, var(--bg) 0%, var(--bg-2) 100%)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 32px" }}>
          ...
          <h1 className="gsap-hero-title" style={{ fontFamily: "var(--font-playfair)", fontSize: "clamp(40px, 6vw, 72px)", fontWeight: 500, lineHeight: 1.05, letterSpacing: "-0.02em", marginBottom: 24, maxWidth: 860 }}>
            Divinus Investment Group Limited.
          </h1>
          <p className="gsap-fade-up" style={{ fontSize: 20, color: "var(--ink-3)", maxWidth: 600, lineHeight: 1.6 }}>
      ...
      <section style={{ padding: "100px 0", background: "var(--bg-2)", borderTop: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 32px" }}>
          <div style={{ marginBottom: 48 }}>
            ...
            <h2 className="gsap-fade-up" style={{ fontFamily: "var(--font-playfair)", fontSize: "clamp(28px, 3.5vw, 40px)", fontWeight: 500, lineHeight: 1.15 }}>Seven Divisions. One Standard.</h2>
          </div>
          <div style={{ display: "flex", flexDirection: "column", gap: 0, border: "1px solid var(--border)", borderRadius: 12, overflow: "hidden" }}>
            {divisions.map((d, i) => (
              <div key={d.name} className="gsap-card" style={{ display: "grid", gridTemplateColumns: "1fr 2fr", padding: "24px 32px", background: i % 2 === 0 ? "var(--bg)" : "transparent", borderBottom: i < divisions.length - 1 ? "1px solid var(--border)" : "none", gap: 32, alignItems: "center" }}>
      ...
      <section style={{ padding: "100px 0", background: "var(--bg)", borderTop: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 1200, margin: "0 auto", padding: "0 32px" }}>
          <div style={{ marginBottom: 56 }}>
            ...
            <h2 className="gsap-fade-up" style={{ fontFamily: "var(--font-playfair)", fontSize: "clamp(28px, 3.5vw, 40px)", fontWeight: 500, lineHeight: 1.15 }}>What We Stand For.</h2>
          </div>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 24 }}>
            {values.map((v) => (
              <div key={v.name} className="gsap-card" style={{ padding: 32, background: "var(--bg-2)", border: "1px solid var(--border)", borderRadius: 12 }}>
      ...
      <section style={{ padding: "100px 0", background: "var(--bg-2)", borderTop: "1px solid var(--border)" }}>
        <div style={{ maxWidth: 760, margin: "0 auto", padding: "0 32px" }}>
          ...
          <h2 className="gsap-fade-up" style={{ fontFamily: "var(--font-playfair)", fontSize: "clamp(28px, 3.5vw, 40px)", fontWeight: 500, lineHeight: 1.15, marginBottom: 32 }}>Why We Were Built.</h2>
